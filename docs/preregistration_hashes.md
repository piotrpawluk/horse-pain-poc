...
| 2026-05-08 | `9a4c1673525732c7aa0277dfa8dc03ac830e92a3765a5f50d3df21fb9c929ed0` | 13261 | `outputs/eye_probe_results.md` | Track A writeup — adds subject-bootstrap CI [0.4138, 0.8980] alongside DeLong [0.4866, 0.8760] for methodological completeness. Phase 3 numbers and decision unchanged. Earlier hashes `915f48d3...` and `5c681bfb...` superseded. |
...
| 2026-05-08 | `0b970228bf888e7330c525d0d0f1cdaeb5adb5a24a61b71d43dd6247a1698528` | 10322 | `outputs/track_b_phase4_preregistration.md` | **Phase 4 pre-registration**, frozen at this commit BEFORE the Phase 4 re-label or v2 extraction. Locks: combined intervention = v2 crop + tightened-rubric relabel only (sub-second filter empirically dropped); 4-band thresholds (≥0.72+CI≥0.55 / 0.65–0.72 / 0.55–0.65 / regression-triggers-ablation); conditional 2-run ablation (A=v1+relabel, B=v2+orig) only on regression < 0.6313; both DeLong + bootstrap CIs reported; memory-contamination risk acknowledged in writing. |
