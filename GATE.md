...
Stos open-source dla detekcji bólu u koni działa end-to-end na macOS Apple Silicon w ~45 min. DLC SuperAnimal-Quadruped jest najmocniejszym ogniwem — out-of-the-box keypoints na koniu są wzrokowo sensowne i są bazą dla detekcji 5 z 24 RHpE behaviors planowanych w Fazie 1. Read My Ears (Faza 1 Etap A) replikuje pipeline 1:1 ale paper accuracy 0.875 nie reprodukuje się w naszym setupie (osiągamy 0.583 — overaggressive na background).
