...
Stos open-source dla detekcji bólu u koni działa end-to-end na macOS Apple Silicon w ~45 min. DLC SuperAnimal-Quadruped jest najmocniejszym ogniwem — out-of-the-box keypoints na koniu są wzrokowo sensowne i są bazą dla detekcji 5 z 24 RHpE behaviors planowanych w Fazie 1. Read My Ears jako research-grade repo wymaga rozszerzenia deps (`ultralytics`) i pobrania ich custom weights — TODO dla Fazy 1, nie blokuje decyzji.
