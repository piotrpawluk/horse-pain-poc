...
[![status](https://img.shields.io/badge/phase_7-DLC_corrected_outperforms_Phase_5_(AUC_only)-success)](docs/phase7_audit.md)
...
**Current focus.** Phase 8 — N expansion + paired-DeLong adjudication of Phase 7's AUC-only OUTPERFORM. Phase 7 closed with DLC keypoint-anchored cropping at AUC **0.8462** vs Phase 5 manual at 0.7985 (Δ +0.048, paired DeLong p=0.619 inconclusive at n=34 due to the same DeLong SE-inflation Phase 5 audit identified). Phase 7 surfaced two structural findings via empirical falsification under the locked discipline pattern (§7 percentile-as-quality-signal conflation; §4 anatomical mapping inverted), both adjudicated with Stage 2 amendments (Option B: in-phase correction with point-fix scope). G3-vs-AUC divergence (median IoU 0.357 with AUC 0.846) softens Phase 5's "manual = architecture ceiling" framing — manual is **a** near-optimum, alternatives may be equivalent or better; Phase 8 N-expansion adjudicates. See [`docs/phase5_audit.md`](docs/phase5_audit.md), [`docs/phase6_audit.md`](docs/phase6_audit.md), [`docs/phase7_audit.md`](docs/phase7_audit.md), [`docs/methodology_discipline_pattern.md`](docs/methodology_discipline_pattern.md).
